import scanpy as sc
import pandas as pd
from genespectra.gene_classification.classify_genes import depth_normalize_counts, prepare_anndata_for_classification
...
def run_classification_cell_pool(inpt_h5ad, out_gene_class, anno_col, **kwargs):
    adata = sc.read_h5ad(inpt_h5ad)
    ...
    data = prepare_anndata_for_classification(input_ad=ad_norm, anno_col=anno_col)
